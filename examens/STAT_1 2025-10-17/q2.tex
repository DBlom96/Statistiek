\begin{question}{25}{
    ...
    \subquestion{6}{
        Met welk aantal zal de productie moeten worden opgeschroefd om met minstens \SI{95}{\percent} kans te kunnen voldoen aan de vraag naar een nieuw gevechtstenue?
    }
    ...
    \solution{
        ...
        \begin{align*}
            P(X \leq k) = \poissoncdf(\mu=4.2, k = \text{ ?}) \geq 0.95. \rubric{1}
        \end{align*}
    ...
    \subquestion{7}{
        ...
        Uitgaande van de productiecapaciteit van $5$ gevechtstenues per dag, hoe lang van tevoren moet de productie worden opgestart om met minstens \SI{95}{\percent} kans genoeg gevechtstenues klaar te hebben liggen voor de reservisten én langmodellers om de eerste dag door te komen?
    }
    ...
    \solution{
        ...
        \begin{align*}
            P(Z \leq k) = \poissoncdf(\mu=12.9, k=\text{ ?}) \geq 0.95. \rubric{1}
        \end{align*}
        Om deze vergelijking op te lossen, gebruik de tabel optie op de grafische rekenmachine en voer in:
        \begin{itemize}
