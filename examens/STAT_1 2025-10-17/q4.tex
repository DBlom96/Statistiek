\begin{question}{20}{
    ...
    \solution{
        Gegeven is dat het aantal donaties per uur tijdens de campagne gemiddeld op $\lambda=3$ ligt.
        Als we mogen aannemen dat de donaties proportioneel binnenkomen volgens de verdeling van bloedgroepen,
        dan houdt dat in dat er gemiddeld $0.46\lambda = 0.46 \cdot 3 = 1.38$ donaties per uur binnenkomen. \rubric{2}
    }
    ...
    \solution{
        ...
        Merk op dat \SI{46}{\percent} van de donaties van bloedgroep $O$ zijn, en dus bruikbaar voor patiënten van bloedgroep $O$.
