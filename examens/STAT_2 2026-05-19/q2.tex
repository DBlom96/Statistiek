\begin{question}{27}{
    ...
    Per vlucht wordt geregistreerd of het voertuig wordt gedetecteerd of niet, zoals te zien in onderstaande tabel:\par\medskip
    \begin{center}
    ...
    \solution{
        Om te bepalen of er een statistisch significant verschil is in detectiekansen tussen de drie terreintypen, kunnen we een chi-kwadraattoets voor onafhankelijkheid gebruiken. \rubric{1}
        De nulhypothese $H_0$ en de alternatieve hypothesetoets $H_1$ kunnen dan als volgt worden geformuleerd:
        \begin{align*}
            H_0: &\quad \text{de detectiekans is niet afhankelijk van het terreintype.} \rubric{1} \\
            H_1: &\quad \text{de detectiekans is wel afhankelijk van het terreintype.} \rubric{1}
        \end{align*}
    }
    ...
    \subquestion{5}{
        Wat is de kansverdeling van de toetsingsgrootheid onder $H_0$? 
        Bepaal met behulp van deze kansverdeling de $p$-waarde.
    }
    \solution{
        ...
        \begin{align*}
            p = P(X^2 > 11.032) &= \chi^2\text{cdf}(\lb=11.032, \ub=10^{99}, \df=2) \\
                                &\approx 0.004.   \rubric{2}
        \end{align*}

        \begin{center}
            \resizebox{0.9\textwidth}{!}{
                \includegraphics{exam20260519_chisq_pval.png} 
            }
        \end{center}
    }
    ...
    \solution{
        ...
        \end{enumerate}
        We vinden het Clopper-Pearson interval door de twee gevonden waarden als grenzen te nemen, oftewel het \SI{95}{\percent}-betrouwbaarheidsinterval voor de detectiekans $p$ van Fennek-voertuigen met de nieuwe camouflagenetten is gelijk aan $[0.2993, 0.4103]$. \rubric{1}

        We zien dat de geclaimde succeskans $p = 0.3$ in het Clopper-Pearson interval ligt. \rubric{1}
