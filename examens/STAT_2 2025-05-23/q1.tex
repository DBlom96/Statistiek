\begin{question}{25}{
    ...
    \subquestion{5}{
        Bereken op grond van deze steekproef een $98\%$-betrouwbaarheidsinterval voor de gemiddelde reactietijd van een cadet die de VR-training heeft afgerond.
    ...
    \subquestion{3}{
        Een van de instructeurs die verantwoordelijk is voor de VR-training beweert dat de gemiddelde reactietijd van een cadet zelfs tot $380$ milliseconden daalt.
        De overige instructeurs willen dit niet meteen voor waarheid aannemen en willen dit graag statistisch verantwoord toetsen.
    ...
    \subquestion{8}{
        ...
        Bepaal de toetsuitslag door het berekenen van het kritieke gebied op basis van de steekproef van 18 cadetten met significantieniveau $\alpha=0,05$.
    }
    \solution{
    ...
    \subquestion{5}{
        ...
        Op dit moment staat het teamrecord op $x$ milliseconden.
        Voor welke waarde van $x$ is de kans dat een nieuw team cadetten het record zal breken gelijk aan $5\%$?
    }
    \solution{
