\begin{enquestion}{20}{
    ...
    \solution{
        ...
        Furthermore, the radar has a \SI{70}{\percent} success rate, so the binomial success probability $p = 0,7$. \rubric{1}

        {\itshape Note: the value of $n$ is NOT equal to $1000$. This number only indicates how many times a binomial random variable is being observed!}
    }
    ...
    \solution{
        ...
        \begin{align*}
            ...
            &\qquad \qquad \text{with $n=4$ and $p=0,7$.} \rubric{1} \\
    ...
    \solution{
        We can evaluate the expected frequencies (under $H_0$) by using the total of $500$ independent trials and the binomial distribution with parameters $n=4$ and $p=0,7$.
        \begin{center}
            \begin{tabular}{ccc}
                \toprule
    ...
    \solution{
        ...
        \begin{align*}
            \chi^2 &= \frac{(15 - 8,1)^2}{8,1} + \ldots + \frac{(230 - 240,1)^2}{240,1} \\
