\begin{enquestion}{17}{
    ...
    \subquestion{6}{Calculate the marginal distributions of $X$ and $Y$, as well as $E[X]$, $\Var{X}$, $E[Y]$ and $\Var{Y}$.
    }
    \ensolution{
        ...
        \begin{center}
            \begin{tabular}{c|ccc|c}
                ...
                \midrule
                    \boldmath$f_Y$ & \boldmath$0.32$ & \boldmath$0.33$ & \boldmath$0.35$ & \boldmath$1$ \rubric{2}\\
                \bottomrule
            \end{tabular}
        \end{center}
    ...
    \subquestion{4}{Calculate the covariance $\Cov{X}{Y}$.}
    \ensolution{
        ...
        \[
            E[XY] = \sum_{x=1}^3\sum_{y=1}^3 x\cdot y \cdot P(X=x, Y=y) = 1 \cdot 1 \cdot 0.20 + 1 \cdot 2 \cdot 0.12 + \ldots + 3 \cdot 3 \cdot 0.17 = 4.02. \rubric{2}
        \]
