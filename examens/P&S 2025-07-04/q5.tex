\begin{enquestion}{15}{
    ...
    \subquestion{6}{Calculate the least-squares estimates $\hat{\beta}_0$ and $\hat{\beta}_{1}$ for the slope and intercept of the linear regression line $Y = \beta_0 + \beta_1 X$, where $Y$ is the deployment time, and $X$ is the vehicle weight.}
    ...
    \ensolution{
        ...
        \begin{center}
            \begin{tabular}{ccccc}
                ...
                \midrule
                    $\overline{X} = 20.8333$ & $\overline{Y} = 18.6517$ & $\overline{XY} = 396.5750$ & $\overline{X^2} = 465.8333$ & $\overline{Y^2} = 351.0376$ \rubric{3}\\
                \bottomrule
            \end{tabular}
        \end{center}
