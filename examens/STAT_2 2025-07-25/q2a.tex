\begin{question}{30}{
    ...
    \solution{
        ...
        \begin{align*}
            \overline{x} = \frac{x_1+x_2+\ldots+x_n}{n} = \frac{ 42 + 45 + \ldots + 47 }{ 13 } \approx 45,9231.\rubric{2}
        \end{align*}
        ...
        \begin{align*}
            s = \sqrt{ s^2 } = \sqrt{ 21,5769 } \approx 4,6451.\rubric{2}
        \end{align*}
    }
    ...
    \solution{
        ...
        De $t$-waarde die hoort bij $94\%$ betrouwbaarheid, oftewel $\alpha = 0,06$, is (in het geval van tweezijdige intervallen) gelijk aan
        \[
            t = \invt(opp=1-\frac{\alpha}{2}; df=n-1) = \invt(opp=0,97; df=12) \approx 2,0764. \rubric{1}
        \]
        Omdat $\sigma$ dus onbekend is, gebruiken we de steekproefstandaardafwijking $s = 4,6451$ als schatter.
        Het betrouwbaarheidsinterval worden dan gegeven door
        \begin{align*}
            [\overline{x} - t \cdot \frac{s}{\sqrt{n}}; \overline{x} + t \cdot \frac{s}{\sqrt{n}}] 
                &= [45,9231 - 2,0764 \cdot \frac{4,6451}{\sqrt{13}}; 45,9231 + 2,0764 \cdot \frac{4,6451}{\sqrt{13}}] \\
                &= [43,2480; 48,5982] \rubric{2}
        \end{align*}
        Om de betrouwbaarheid te waarborgen, mag het interval niet kleiner worden, dus naar buiten afronden: $[43; 49]$. 
        Met \SI{94}{\percent} betrouwbaarheid ligt de gemiddelde doorlooptijd van een sollicitatieprocedure tussen de $43$ en $49$ dagen.\rubric{1}
    }
