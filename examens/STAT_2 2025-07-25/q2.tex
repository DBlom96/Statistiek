\begin{question}{28}{
    ...
    \subquestion{10}{
        Voer een $F$-toets uit en bepaal met behulp van de $p$-waarde of de varianties in de maximale G-belasting gelijk zijn voor beide populaties. Kies voor het significantieniveau $\alpha = 0,05$.
    }
    \solution{
        ...
        \[
            F = \frac{S_A^2}{S_B^2}, 
        \]
        en volgt een $F(n-1, m-1)$-verdeling, oftewel een $F(9,9)$-verdeling. \rubric{2}

        De geobserveerde toetsingsgrootheid is gelijk aan
        \[
            f = \frac{s_A^2}{s_B^2} = \frac{0,0778}{0,0529} \approx 1,4707. \rubric{2}
        \]
