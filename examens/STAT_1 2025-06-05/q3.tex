\begin{question}{29}{
    ...
    \solution{
        In een willekeurige week is zijn reistijd $T$ normaal verdeeld met gemiddelde $\mu = 140$ en standaardafwijking $\sigma=16$ minuten.
        ...
        \begin{align*}
            P(T > 150) = \normalcdf(\lb=150, \ub=10^{99}, \mu=140, \sigma=16) \approx 0.2660. \rubric{3}
        \end{align*}
    }
    ...
    \solution{
        ...
        \end{align*}
        Met \SI{12.72}{\percent} kans zal hij in een half jaar minstens 3 keer langer dan $2\frac{1}{2}$ uur over zijn busrit doen.\rubric{1}
    ...
    \solution{
        ...
        met verwachtingswaarde $\mu=140$ en standaardafwijking $\frac{\sigma}{\sqrt{52}} = \frac{16}{\sqrt{52}}$. \rubric{2}
        ...
        \begin{align*}
            P(\overline{T} \ge 135) = \normalcdf(\lb=135, \ub=10^{99}, \mu=140, \sigma=\frac{16}{\sqrt{52}}) \approx 0.9879.\rubric{3}
        \end{align*} 
        Met \SI{98.79}{\percent} kans zal hij in een jaar gemiddeld langer dan $2$ uur en een kwartier doen over zijn busrit.\rubric{1}
    }
    ...
    \solution{
        ...
        Als hij vóór $10.00$ uur aankomt op het KIM, dan betekent dat dat $A < 600$. \rubric{1}
        Omdat $A = V + 127$, betekent dat ook dat $V = A - 127 = 600 - 127 = 473$ minuten.\rubric{1}
        De kans dat meneer de Wolf vóór $10.00$ uur aankomt op het KIM is dus gelijk aan de kans dat hij vóór $7.53$ uur vertrekt, oftewel:
        \begin{align*}
            P(A < 600) = P(V < 473) &= \normalcdf(\lb=-10^{99}, \ub=473, \mu=479, \sigma=4) \\
                                    &\approx 0.0668 \rubric{3}
        \end{align*}
        Met kans \SI{6.68}{\percent} komt meneer de Wolf vóór $10.00$ uur aan op het KIM.\rubric{1}

    }

    \subquestion{4}{
        Hoe laat moet meneer de Wolf `s ochtends uiterlijk vertrekken om te zorgen dat hij met kans $0.95$ vóór $10.00$ uur op het KIM aankomt? 
    ...
    \solution{
        ...
        Dit kunnen we doen met behulp van de \enquote{InvNorm} functie op de grafische rekenmachine.
        \[
            t = \invnorm(\opp=0.95, \mu=140,\sigma=16) \approx 166.3177.\rubric{1}
        \]
        Met \SI{95}{\percent} kans duurt de reis korter dan $167$ minuten (naar boven afgerond op hele minuten). \rubric{1}
