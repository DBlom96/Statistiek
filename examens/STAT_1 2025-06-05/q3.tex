\begin{question}{29}{
    ...
    \solution{
        ...
        Het aantal keer $N$ dat meneer de Wolf in een half jaar meer dan $2\frac{1}{2}$ uur erover doet om van de KMA naar het KIM te rijden is binomiaal verdeeld met $n = 26$ en $p = 0,2660$. \rubric{1}
        Dit geeft een kans voor minstens 10 keer langer dan $2\frac{1}{2}$ uur van
        \begin{align*}
            P(N \ge 10) = 1 - P(N \le 9)    &= 1 - \binomcdf(n=26; p=0,2660; k=9) \\
                                            &\approx 0,1272. \rubric{2}
        \end{align*}
    ...
    \solution{
        ...
        Omdat de reistijden onafhankelijk zijn en normaal verdeeld met dezelfde $\mu$ en $\sigma$, 
        kunnen we volgens de centrale limietstelling zeggen dat de gemiddelde reistijd $\overline{T}$ over 52 weken ook normaal verdeeld is,
        ...
        \begin{align*}
            P(\overline{T} \ge 135) = \normalcdf(a=135; b=10^{99}; \mu=140; \sigma=\frac{16}{\sqrt{52}}) \approx 0,9879 \rubric{2}
        \end{align*} 
    ...
    \subquestion{8}{
        ...
        {\scriptsize\textbf{Hint:} de aankomsttijd is de som $A = V + T$ van twee normaal verdeelde kansvariabelen (de vertrektijd $V$ en de reistijd $T$). 
        Er geldt dat $A$ dus ook normaal verdeeld is met $E[A] = E[V] + E[T]$ en $\sigma(A) = \sqrt{\sigma(V)^2+\sigma(T)^2}$.}
    }
    \solution{
        De aankomsttijd $A$ is de som van twee kansvariabelen, namelijk $A = V + T$, waarbij $V$ is de vertrektijd en $T$ is de reistijd.\rubric{1}

        We bepalen de tijden in minuten na middernacht.
        De vertrektijd heeft verwachtingswaarde $E[V] = 7 \cdot 60 + 59 = 479$ minuten en standaardafwijking $\sigma(V) = 4$ minuten. \rubric{1}

        De reistijd heeft verwachtingswaarde $E[T] = 140$ minuten en standaardafwijking $\sigma(T) = 14$ minuten.
        Er geldt dus dat de aankomsttijd $A$ normaal verdeeld is met verwachtingswaarde $E[A] = E[V]+E[T] = 479+140 = 619$ minuten en standaardafwijking $\sigma(A) = \sqrt{\sigma(V)^2+\sigma(T)^2} = \sqrt{4^2+16^2} \approx 16,4924$ minuten. \rubric{3}

        De kans dat hij v\'o\'or 10.00 uur, oftewel $A < 600$ minuten, is gelijk aan
        \begin{align*}
            P(A < 600) = \normalcdf(a=-10^{99}; b=600; \mu=619;\sigma=16,4924) \approx 0,1247 \rubric{2}
        \end{align*}
        Met kans $12,47\%$ komt meneer de Wolf v\'o\'or 10.00 uur aan op het KIM.\rubric{1}
    ...
    \solution{
        We hebben een gegeven aankomsttijd $a = 10 \cdot 60 = 600$, dus de enige factor die er nu toe doet om een uiterste vertrektijd te berekenen is de reistijd $T$. \rubric{1}
        ...
        \[
            t = \invnorm(opp=0,95; \mu=140; \sigma=16) \approx 166,3177.
        \]
        Met $95\%$ kans duurt de reis korter dan $167$ minuten (naar boven afgerond op hele minuten). \rubric{2}
        De uiterste vertrektijd $v$ vinden we aan de hand van $v = a - t = 600 - 167 = 433$ minuten.
        Omgerekend naar uren geeft dit een tijdstip van $7.13$ uur. \rubric{2}
    }
