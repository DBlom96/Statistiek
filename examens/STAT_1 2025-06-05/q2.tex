\begin{question}{25}{
    ...
    \solution{
        ...
        Er geldt dus dat $X$ Poisson verdeeld is met gemiddeld $\mu=9$ storingen. \rubric{1}

        De kans dat er in die zes maanden precies tien storingen plaatsvinden is dus gelijk aan
        \[
            P(X = 10) = \poissonpdf(\mu=9, k=10) \approx 0.1186. \rubric{2}
        \]
    }
    ...
    \subquestion{7}{
        ...
        \begin{enumerate}
            \item het doorvoeren van technologische upgrades die de uitvalfrequentie met \SI{10}{\percent} verminderen.
    ...
    \solution{
        Zodra optie $1$ wordt doorgevoerd, wordt de uitvalfrequentie met \SI{10}{\percent} vermindert, oftewel de gemiddelde uitvalfrequentie per maand daalt van $1.5$ naar $0.9 \cdot 1.5 = 1.35$ storingen.\rubric{1}
    ...
    \solution{
        ...
        Deze kansvariabele $Y$ heeft de volgende kansfunctie:\medskip
        \begin{center}
            \begin{tabular}{cc}
                \toprule
