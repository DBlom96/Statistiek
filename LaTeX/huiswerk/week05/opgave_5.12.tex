...
\begin{enumerate}[label=(\alph*)]
    ...
    \answer{
        Gegeven is dat de tijdsduur $X \sim \normal{\mu=45}{\sigma=10}$.
        De kans dat een willekeurig bezoek meer dan $60$ minuten vergt is dus $P(X > 60)$.

        De $z$-score van $x=60$ gegeven $X \sim \normal{\mu=45}{\sigma=10}$ is gelijk aan:
        \[
        ...
        \begin{align*}
            P(X > 60)   &= P(Z > 1.5) \\
                        &= \normalcdf(\lb=1.5, \ub=\GRinfinity, \mu=0, \sigma=1) \\
                        &\approx 0.0668.
        \end{align*}
    ...
    \answer{
        ...
        De $z$-score van $x = 390$ ($6\frac{1}{2}$ uur $=$ $390$ minuten) gegeven $\sum X \sim \normal{\mu=360}{\sigma=28.2843}$ is gelijk aan
        \[
        ...
        \begin{align*}
            P(\sum X > 390)     &= P(Z > 1.0607) \\
                                &= \normalcdf(\lb=1.0607, \ub=\GRinfinity, \mu=0, \sigma=1) \\
                                &\approx 0.1444.
        \end{align*}
    ...
    \answer{
        ...
        Volgens de centrale limietstelling geldt dat de som $\sum X = X_1 + X_2 + \ldots + X_8$ normaal verdeeld is met gemiddelde $n \cdot \mu = 10 \cdot 45 = 450$ minuten en standaardafwijking $\sigma \cdot \sqrt{n} = 10 \cdot \sqrt{10}$.
        ...
        \]
        Terugrekenen naar de bijbehorende uitkomst $T$ voor de kansverdeling $\normal{\mu=450}{\sigma=10\sqrt{10}}$ van $\sum X$ geeft:
        \[
            T = \mu + z \cdot \sigma = 450 + 1.6449 \cdot 10\sqrt{10} \approx 502.0148.
        \]
        De vertegenwoordiger moet meer dan $8$ uur en $22$ minuten reserveren om de tien bezoeken met \SI{95}{\percent} kans binnen de tijd af te kunnen handelen.
    }
\end{enumerate}