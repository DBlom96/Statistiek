...
\begin{enumerate}[label=(\alph*)]
    ...
    \end{enumerate}
    \answer{
        Om een kansfunctie te zijn moeten alle waarden voor $f(k)$ kansen zijn, dus getallen tussen $0$ en $1$. 
        Verder moet de som van alle kansen gelijk zijn aan $1$.
        Dit is alleen het geval voor $C$ en $D$.
    }
