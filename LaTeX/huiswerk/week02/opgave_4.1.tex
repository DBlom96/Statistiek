...
\begin{enumerate}[label=(\alph*)]
    ...
    \answer{
        ...
        \begin{align*}
            E(X)    &= \sum_k k \cdot P(X=k) \\
                    &= 30 \cdot P(X=30) + 35 \cdot P(X=35) + \ldots + 50 \cdot P(X=50) \\
    ...
    \answer{
        We berekenen de opbrengst van de verschillende aantallen die gevraagd kunnen worden.
        De opbrengst per zaterdag definiëren we als de kansvariabele $Y$.
        \begin{itemize}
            \item Bij een vraag van $30$ stuks worden $10$ kranten niet verkocht, en bedraagt de opbrengst $30 \cdot 0.85 + 10 \cdot (-1.40) = \text{\euro} 11.50$.
            \item Bij een vraag van $35$ stuks worden $5$ kranten niet verkocht, en bedraagt de opbrengst $35 \cdot 0.85 + 5 \cdot (-1.40) = \text{\euro} 22.75$.  
            \item Bij een vraag van (minstens) $40$ stuks worden alle kranten verkocht, en bedraagt de opbrengst $40 \cdot 0.85 = \text{\euro} 34$.
        \end{itemize}
        De kansvariabele $Y$ kan dus als volgt worden beschreven:
        \begin{center}
            \begin{tabular}{c|ccc}
                \toprule
                    {\bfseries Winst $y$} & $11.50$ & $22.75$ & $34$ \\
                \midrule
                    {\bfseries $P(Y = y)$} & $0.10$ & $0.35$ & $0.55$ \\
                \bottomrule
            \end{tabular}
        \end{center}
