...
\end{center}
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        \answer{
            ...
            We mogen dit zeggen omdat de verwachtingswaarde van een som van kansvariabelen $X_{\text{som}} = X_1 + X_2 + X_{50}$ gelijk is aan de som van verwachtingswaarden, oftewel:
            \begin{align*}
