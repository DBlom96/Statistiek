...
\end{center}
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        Maak een kanstabel voor de variabele $X_{\text{som}}$ waarmee het aantal boekingen per twee dagen wordt aangegeven.
        Hoe groot is de kans dat in twee dagen meer dan 3 boekingen plaatsvinden?
        \answer{
            De kansvariabele $X_{\text{som}}$ telt het aantal boekingen in twee dagen.
            De mogelijke uitkomsten van $X_{\text{som}}$ zijn $0, 1, 2, 3, 4, 5$ of $6$.
            We kunnen de kansen van $X_{\text{som}}$ berekenen door alle combinaties van het aantal boekingen $X_1$ en $X_2$ op de eerste en tweede dag te combineren, aangezien $X_{\text{som}}$ de som is van twee onafhankelijke variabelen die dezelfde verdeling hebben als $X$.
