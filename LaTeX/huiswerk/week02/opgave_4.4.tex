\question{4.4}{
    Het aantal augurken dat in een halveliterpot zit, blijkt enigszins te variëren. 
...
\begin{enumerate}[label=(\alph*)]
    ...
    \answer{
        Als er twee willekeurige potten geselecteerd worden, dan geldt dat beide potten met kans $P(X > 18) = 1 - P(X \le 18) = 1 - 0.85 = 0.15$ meer dan $18$ augurken bevatten.
    ...
    \answer{
        ...
        \begin{align*}
            P(X_1+X_2=38) &= P(X_1 = 18, X_2=20) + P(X_1 = 19, X_2=19) \\
                          ...
                          &= 0.025.
        \end{align*}
        Met \SI{2.5}{\percent} kans is het totaal aantal augurken in twee willekeurige potten samen gelijk aan $38$.
    }
    \end{enumerate}