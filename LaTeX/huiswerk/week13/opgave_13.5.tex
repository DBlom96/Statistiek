...
\begin{enumerate}[label=(\alph*)]
    ...
    \answer{
        ...
        \begin{center}
            \begin{tabular}{ccccc}
                ...
                \midrule
                    $\samplemeanx = 50$ & $\samplemeany = 25.13$ & $\samplemeanxy = 2035$ & $\samplemeanxsquared = 12500$ & $\samplemeanysquared = 692.09$ \\
                \bottomrule
            \end{tabular}
        \end{center}
    ...
    \answer{
        ...
        {
            \itshape Noot: we zijn in dit geval ver buiten de dataset aan het extrapoleren, want we hebben de regressielijn bepaald op basis van metingen voor temperaturen tussen \SI{-100}{\celsius} en \SI{200}{\celsius}.
    ...
    \answer{
        ...
        \end{align*}  
        Deze lijn heeft dus exact dezelfde richtingscoëfficiënt (en is dus evenwijdig aan de regressielijn met de verklarende variabele $X$), maar heeft een lager gelegen snijpunt met de $Y$-as.
    }
\end{enumerate}