\question{13.9}{
    ...
    \begin{center}
        \begin{tabular}{ccc}
            \toprule
                {\bfseries Auto nummer} & {\bfseries Leeftijd in jaren (\boldmath$X$)} & {\bfseries Onderhoudskosten (\boldmath$Y$) in de laatste $12$ maanden} \\            \cmidrule{1-1} \cmidrule{2-2} \cmidrule{3-3} \cmidrule{4-4} \cmidrule{5-5} \cmidrule{6-6} \cmidrule{7-7}
                $A$ & $1,6$ & $450$ \\
                $B$ & $6,8$ & $930$ \\
                $C$ & $5,1$ & $670$ \\
                $D$ & $7,2$ & $920$ \\
