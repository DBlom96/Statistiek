...
\begin{enumerate}[label=(\alph*)]
    ...
    \answer{
        ...
        Vervolgens kunnen we een puntschatting berekenen van de standaardafwijking van $Y \mid X = x_0$:
        \begin{align*}
        ...
        \]
        Het $95\%$-betrouwbaarheidsinterval voor de gemiddelde $Y$ voor $X = x_0$ kan dus worden beschreven door
        \begin{align*}
