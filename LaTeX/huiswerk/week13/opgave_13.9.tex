...
\begin{enumerate}[label=(\alph*)]
    ...
    \answer{
        ...
        De $t$-waarde die hoort bij een voorspellingsinterval met $\alpha = 0.05$ is gelijk aan
        \[
            t = \invt(\opp = 1 - \alpha / 2, \df = n - 2) = \invt(\opp = 0.975, \df = 8) \approx 2.3060.
        \]
        Het \SI{95}{\percent}-voorspellingsinterval voor $Y$ bij een gegeven $X = x_0$ kan dus worden beschreven door
        \begin{align*}
