...
\begin{enumerate}[label=(\alph*)]
    ...
    \answer{
        ...
        \end{align*}
        We moeten dus een tabel construeren met de gemiddelde $\samplemeanx$, $\samplemeany$, $\samplemeanxy$ en $\samplemeanxsquared$.
        \begin{center}
            \begin{tabular}{cccc}
                \toprule
                    $x$ & $y$ & $xy$ & $x^2$ \\
                \midrule
                    ...
                    $73$ & $0.96$ & $70.08$ & $5329$ \\
                \midrule       			
                    $\samplemeanx = 78$ & $\samplemeany = 0.85$ & $\samplemeanxy = 65.013$ & $\samplemeanxsquared = 6190$ \\
                \bottomrule
            \end{tabular}
        \end{center}
    ...
    \item Bereken de correlatiecoëfficiënt.
    \answer{
        De correlatiecoëfficiënt $r(x, y)$ berekenen we op basis van de formule
        \[
            r(x, y) = \frac{\samplemeanxy - \samplemeanx \cdot \samplemeany}{\sqrt{(\samplemeanxsquared - \samplemeanx^2) \cdot (\samplemeanysquared - \samplemeany^2)}}
        \]
        ...
        \begin{center}
            \begin{tabular}{ccccc}
                ...
                \midrule       			
                    $\samplemeanx = 78$ & $\samplemeany = 0.85$ & $\samplemeanxy = 65.013$ & $\samplemeanxsquared = 6190$ & $\samplemeanysquared = 0.7389$ \\
                \bottomrule
            \end{tabular}
        \end{center}
        De correlatiecoëfficiënt $r(x, y)$ is dus gelijk aan
        \begin{align*}
            r(x,y)  &= \frac{\overline{x \cdot y} - \samplemeanx \cdot \samplemeany}{\sqrt{(\samplemeanxsquared - \samplemeanx^2) \cdot (\samplemeanysquared - \samplemeany^2)}} \\
                    &= \frac{65.013 - 78 \cdot 0.85}{\sqrt{(6190 - 78^2) \cdot (0.739 - 0.85^2)}} \\
                    &= \frac{-1.287}{1.318} \\
                    &\approx -0.9761.
        \end{align*}
        {\itshape Noot: de correlatiecoëfficiënt $r(x, y)$ ligt erg dicht in de buurt van $-1$, wat inhoudt dat er een sterke negatieve correlatie is tussen de variabelen bloedalcoholgehalte en gewicht en dat de datapunten vrijwel op een lijn liggen.
    ...
    \answer{
        ...
        Dat betekent ook dat $\samplemeany$ en $\samplemeanxy$ met een factor $1.2$ groter worden.
        De gemiddelde voor $x$ en $x^2$ blijven hetzelfde.
        Met andere woorden, we krijgen $\samplemeanx_{\text{n}} = \samplemeanx$, $\samplemeany_{\text{n}} = 1.2\samplemeany$, $\samplemeanxy_{\text{n}} = 1.2\samplemeanxy$, $\samplemeanxsquared_{\text{n}} = \samplemeanxsquared$.
        De formule van de (nieuwe) regressielijn $Y = a_{\textrm{n}} + b_{\textrm{n}} \cdot X$ kunnen we opstellen met behulp van:
        \begin{align*}
            b_{\textrm{n}} &= \frac{\samplemeanxy_{\textrm{n}} - \samplemeanx_{\textrm{n}} \cdot \samplemeany_{\textrm{n}}}{\samplemeanxsquared_{\textrm{n}} - (\samplemeanx_{\textrm{n}})^2} = \frac{(1.2 \cdot \samplemeanxy) - \samplemeanx \cdot (1.2 \cdot \samplemeany)}{\samplemeanxsquared - (\samplemeanx)^2} = \frac{1.2 \cdot (\samplemeanxy - \samplemeanx \cdot \samplemeany)}{\samplemeanxsquared - (\samplemeanx)^2} = 1.2 \cdot b, \\
            a_{\textrm{n}} &= \samplemeany_{\textrm{n}} - b_{\textrm{n}} \cdot \samplemeanx_{\textrm{n}} = 1.2 \cdot \samplemeany - \left(1.2 \cdot b\right) \cdot \samplemeanx = 1.2 \cdot (\samplemeany - b \cdot \samplemeanx) = 1.2 \cdot a.
        \end{align*}
