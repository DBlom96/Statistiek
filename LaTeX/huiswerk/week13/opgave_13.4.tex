    ...
    \answer{
        ...
        \begin{align*}
            r(x,y)  &= \frac{\overline{x \cdot y} - \samplemeanx \cdot \samplemeany}{\sqrt{(\samplemeanxsquared - \samplemeanx^2) \cdot (\samplemeanysquared - \samplemeany^2)}} \\
                    ...
                    &\approx -0.9761.
        \end{align*}
        {\itshape Noot: de correlatieco\"effici\"ent $r(x, y)$ ligt erg dicht in de buurt van $-1$, wat inhoudt dat er een sterke negatieve correlatie is tussen de variabelen bloedalcoholgehalte en gewicht en dat de datapunten vrijwel op een lijn liggen.
