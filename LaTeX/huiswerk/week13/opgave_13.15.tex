...
\begin{enumerate}[label=(\alph*)]
    ...
    \answer{
        ...
        Om de bijbehorende regressielijn te bepalen, construeren we allereerst de rekentabel met de gemiddeldes $\samplemeanx$, $\samplemeany$, $\samplemeanxy$, $\samplemeanxsquared$ en $\samplemeanysquared$:
        ...
        \begin{center}
            \begin{tabular}{ccccc}
                ...
                \midrule
                    $\samplemeanx = 1.3$ & $\samplemeany = 140$ & $\samplemeanxy = 192.9$ & $\samplemeanxsquared = 1.838$ & $\samplemeanysquared = 20480$ \\
                \bottomrule
            \end{tabular}
        \end{center}
        
        Op basis van de bovenstaande tabel kunnen we de coëfficiënten $a$ en $b$ van de regressielijn bepalen:
        \begin{align*}
    ...
    \item Voorspel aan de hand van de gevonden lijn de maximumsnelheid van een auto met een cilinderinhoud van $1.5$ liter.
    \answer{
    ...
    \answer{
        ...
        \begin{align*}
            s_{\varepsilon}^2 &= \frac{n}{n-2} \cdot \left( \samplemeanysquared - a \cdot \samplemeany - b \cdot \samplemeanxy \right) \\ 
    ...
    \answer{
        ...
        \]
        Het \SI{95}{\percent}-voorspellingsinterval voor $Y$ bij een gegeven $X = 1.45$ kan dus worden beschreven door
        \begin{align*}
