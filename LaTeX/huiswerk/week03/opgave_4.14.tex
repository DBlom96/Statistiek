...
\begin{enumerate}[label=(\alph*)]
    ...
    \answer{
        ...
        \begin{align*}
            P(80 \le X \le 100)   &= F(100) - F(80) \\
                                        ...
                                        &= 0.20.
        \end{align*}
        Aangezien afzonderlijke draaien onafhankelijk zijn van elkaar (oftewel de uitkomst van een draai verandert niet de kansverdeling van andere draaien)
        is de kans op drie keer een uitkomst tussen $80$ en $100$ gelijk aan $0.20 \cdot 0.20 \cdot 0.20 = 0.008$.
    }
    ...
    \answer{
        Opnieuw hebben we te maken met het feit dat de twee draaien onafhankelijk van elkaar plaatsvinden.
        Deze kans iss gelijk aan 
        \begin{align*}
    ...
    \answer{
        De kans dat de tweede draai een uitkomst groter dan $60$ oplevert gelijk aan
        \[
    ...
    \answer{
        ...
        \begin{align*}
            P(X > A)    &= 1 - P(X \le A) \\
                        &= 1 - F(A) \\
                        &= 1 - \frac{A}{100} \quad (= \frac{100}{100} - \frac{A}{100}= \frac{100-A}{100}).
        \end{align*}
    }
