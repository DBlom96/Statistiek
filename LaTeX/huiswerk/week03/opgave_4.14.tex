...
\begin{enumerate}[label=(\alph*)]
    ...
    \answer{
        Bij het rad hebben we te maken met een uniforme verdeling tussen linkergrens $a=0$ en rechtergrens $b=100$.
        Laat $X$ de kansvariabele zijn die de waarde beschrijft van een draai aan het rad.
        Een uitkomst van deze kansvariabele is een getal $x$ tussen $0$ en $100$.
