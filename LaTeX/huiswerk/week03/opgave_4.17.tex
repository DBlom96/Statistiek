\question{4.17}{
    Een conservatoriumstudent oefent per dag tussen $180$ en $300$ minuten. 
    Het aantal oefenuren op een willekeurige dag kan worden weergegeven
...
\begin{enumerate}[label=(\alph*)]
    ...
    \item Hoe groot is de kans dat de student op een willekeurige dag minder dan $210$ minuten oefent? 
    Hoe groot is de kans dat hij tussen $200$ en $260$ minuten oefent?
    \answer{
        De kans dat een student op een willekeurige dag minder dan $210$ minuten, oftewel $3.5$ uur oefent, is gelijk aan
        \[
            P(X \le 3.5) = \int_{-\infty}^{3.5} f(x) \dx = \int_{3.00}^{3.5} 0.40 \dx = \fnInt(0.40, X, 3.00, 3.5) = 0.2.
        \]
        ...
        \begin{align*}
            P(\frac{10}{3} \le X \le \frac{13}{3}) &= \int_{\frac{10}{3}}^{\frac{13}{3}} f(x) \dx \\
                                                   ...
                                                   &= \fnInt(0.40, X, \frac{10}{3}, 4.00) + \fnInt(0.60, X, 4.00, \frac{13}{3}) \\
                                                   &\approx 0.4667.
        \end{align*}
    }
    ...
    \answer{
        ...
        \begin{align*}
            E(X)    &= \int_{-\infty}^{\infty} x \cdot f(x) \dx \\
                    ...
                    &= \fnInt(0.40X, X, 3.00, 4.00) + \fnInt(0.60X, X, 4.00, 5.00) \\
                    &= 4.1.
        \end{align*}
        De verwachte dagelijkse studietijd is $4.1$ uur, oftewel $246$ minuten.

        \textbf{Noot:} als je de opdeling in twee integralen niet intu\"itief vindt, bekijk dan de visualisatie van de kansdichtheidsfunctie bij (a).
        Kansen berekenen we namelijk aan de hand van oppervlaktes onder de grafiek!
    }
\end{enumerate}