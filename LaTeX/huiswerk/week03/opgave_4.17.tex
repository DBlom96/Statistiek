...
\begin{enumerate}[label=(\alph*)]
    ...
    \answer{
        ...
        \[
            P(X \le 3.5) = \int_{-\infty}^{3.5} f(x) \dx = \int_{3.00}^{3.5} 0.40 \dx = 0.2. %= \fnInt(0.40, X, 3.00, 3.5) = 0.2.
        \]
        ...
        \begin{align*}
            P(\frac{10}{3} \le X \le \frac{13}{3}) &= \int_{\frac{10}{3}}^{\frac{13}{3}} f(x) \dx \\
                                                   ...
                                                   &\approx 0.4667.%&= \fnInt(0.40, X, \frac{10}{3}, 4.00) + \fnInt(0.60, X, 4.00, \frac{13}{3}) \\
                                                %    &\approx 0.4667.
        \end{align*}
        \begin{center}
            \resizebox{0.9\textwidth}{!}{
                \includegraphics{opg4.17.png}
            }
        \end{center}
    }
    ...
    \answer{
        ...
        \begin{align*}
            E(X)    &= \int_{-\infty}^{\infty} x \cdot f(x) \dx \\
                    ...
                    &= 4.1.%&= \fnInt(0.40X, X, 3.00, 4.00) + \fnInt(0.60X, X, 4.00, 5.00) \\
                    % &= 4.1.
        \end{align*}
