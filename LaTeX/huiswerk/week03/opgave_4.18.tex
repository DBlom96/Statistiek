...
\begin{enumerate}[label=(\alph*)]
    ...
    \answer{
        Gegeven is dat het bod van zijn concurrent $X$ wordt gemodelleerd als een uniforme kansvariabele op het interval tussen \euro 20 000 en \euro 30 000, met andere woorden $X \sim \uniform{20 000}{30 000}$.
    ...
    \answer{
        ...
        Daarnaast is Lauwen bij $B = 30 000$ al verzekerd van aankoop van de klok, dus heeft hij geen reden om een hoger bod uit te brengen.
        ...
        Je kunt dus de winst $W$ zien als een discrete kansvariabele met twee mogelijke uitkomsten:
            ...
            \begin{align*}
                &\frac{d}{dB}(-62 000 + 5.1\cdot B-\frac{1}{10000}\cdot B^2) = 5.1 - \frac{2}{10000}\cdot B = 0 \\
