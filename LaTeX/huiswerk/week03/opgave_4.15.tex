...
\begin{enumerate}[label=(\alph*)]
    ...
    \answer{
        ...
        \[
            \int_{\infty}^{\infty} f(x) \dx = \int_{5}^{10} 0.20 \dx = 1. % \fnInt(0.20, X, 5, 10) = 1.
        \]
        ...
        Met de grafische rekenmachine checken we dat verder geldt:
        \[
            \int_{\infty}^{\infty} f(x) \dx = \int_{5}^{10} \left(\frac{2}{5}x-2\right) \dx= 5. %\fnInt(\frac{2}{5}X-2, X, 5, 10) = 5.
        \]
