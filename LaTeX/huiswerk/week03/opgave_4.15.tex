...
\begin{enumerate}[label=(\alph*)]
    ...
    \answer{
        ...
        \]
        oftewel voor iedere $x$ is $F(x)$ gelijk aan de oppervlakte onder de grafiek van $f$ van $-\infty$ tot en met $x$.
        ...
        \[
            F(x) = \int_{-\infty}^{x} f(y) \dy = \int_{-\infty}^{5} 0 \dy + \int_{5}^{x} 0.2 \dy = 0.2(x - 5)
        \]
