...
\answer{
    ...
    We veronderstellen dat beide steekproeven te beschouwen zijn als trekking uit (normale) verdelingen met dezelfde variantie, dus kunnen we gebruik maken van de \enquote{pooled variance}:
    \[
    ...
    De $t$-waarde bijbehorende bij de uitkomst $v = \samplemeanx - \samplemeany = 164.6 - 143.2 = 21.4$ is gelijk aan
    \[
        t = \frac{v - \mu_V}{s_V} = \frac{21.4 - 0}{5.2376} = 4.0858.
    \]

    Merk op dat deze $t$-waarde uit een $t$-verdeling komt met $\df=n-m+2=38$ vrijheidsgraden.
    ...
    \end{align*}
    De geobserveerde toetsingsgrootheid $t \approx 4.0858$ is groter dan deze grens $g$, dus $t$ ligt in het kritieke gebied.
    ...
    \begin{align*}
        p = \tcdf(\lb=4.0858; \ub=10^{99}; \df=38) \approx 1.0936 \cdot 10^{-4}.
    \end{align*}
