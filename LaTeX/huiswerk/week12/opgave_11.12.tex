...
\answer{
    ...
    \begin{align*}
        p &= \normalcdf(\lb=1.15, \ub=\GRinfinity, \df_1=5, \df_2=9) \approx 0.4020.
    \end{align*}
    ...
    \begin{align*}
        \samplemeanx = 350 \qquad s_X^2 = 4600 \qquad n = 6 \\
        \samplemeany = 450 \qquad s_Y^2 = 4000 \qquad m = 10 \\
    \end{align*}
    ...
    Omdat we met de pooled variance werken, is het aantal vrijheidsgraden gelijk aan $\df=n+m-2=14$.
    \begin{align*}
    ...
    \begin{align*}
        p &= \tcdf(\lb=-\GRinfinity, \ub=-2.7868, \df=14) \approx 0.0073.
    \end{align*}
