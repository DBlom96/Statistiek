...
\answer{
    ...
    \begin{align*}
        X &\sim \normal{\mu_X =\ ?}{\sigma_X = \sqrt{100}=10}, \\
        Y &\sim \normal{\mu_Y =\ ?}{\sigma_Y = \sqrt{30}}. 
    \end{align*}
    ...
    Als toetsingsgrootheid kijken we naar de verschilvariabele $V = \samplemeanvarX - \samplemeanvarY$.
    Hiervoor geldt dat
    \begin{align*}
        V = \samplemeanvarX - \samplemeanvarY = \normal{\mu_V = \mu_X - \mu_Y}{\sigma_V = \sqrt{\frac{\sigma_X^2}{n}+\frac{\sigma_Y^2}{m}} = \sqrt{\frac{100}{10}+\frac{30}{5}} = 4}.
    \end{align*}
    ...
    \begin{align*}
        g_1 &= \invnorm(\opp=\alpha/2=0.025, \mu = \mu_V=0, \sigma = \sigma_V=4) \approx -7.8399, \\
        g_2 &= \invnorm(\opp=1-\alpha/2=0.975, \mu = \mu_V=0, \sigma = \sigma_V=4) \approx 7.8399.
    \end{align*}
    Het geobserveerde verschil is $v = \samplemeanx - \samplemeany = 50 - 55 = -5$.
    ...
    Het geobserveerde verschil is $v = \samplemeanx - \samplemeany = 50 - 55 = -5$ en ligt dus links van het gemiddelde $\mu_V = 0$.
    ...
    \begin{align*}
        p &= \normalcdf(\lb=-\GRinfinity, \ub=-5, \mu = 0, \sigma = 4) = 0.1056
    \end{align*}
