...
\answer{
    ...
    Hierdoor is een $F$-toets niet meer benodigd.
    ...
    Omdat we tweezijdig toetsen, berekenen we de $p$-waarde als de rechteroverschrijdingskans van de waarde $3.1217$ (omdat deze waarde groter dan $0$ is) en vergelijken deze met $\alpha/2 = 0.005$.
    \begin{align*}
        p &= \normalcdf(\lb=3.1217, \ub=\GRinfinity, \df=16) \approx 0.0033.
    \end{align*}
