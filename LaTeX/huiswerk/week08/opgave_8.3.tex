...
\answer{
    Gegeven is de standaardafwijking $\sigma = 1.2$ mg en de gewenste betrouwbaarheid van \SI{95}{\percent}, dus $\alpha=0.05$.
    ...
    Omdat $\alpha = 0.05$, werken we verder met $z_{\alpha/2} = z_{0.025} = \invnorm(\opp=1-0.025=0.975) \approx 1.9600$.
    ...
    \begin{align*}
        ...
        &=[13.89; 15.81]
    \end{align*}
    Met \SI{95}{\percent} ligt de gemiddelde hoeveelheid stof per monster tussen $13.89$ en $15.81$ mg.
}
