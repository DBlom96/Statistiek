...
\answer{
    ...
    Het aantal noodlandingen in zes maanden kan dus worden beschouwd als een Poisson verdeelde kansvariabele $X \sim \poisson{\lambda=0.5 \cdot 6} = \poisson{\lambda=3}$.
