\question{7.6}{
    ...
    Bekend is dat het aantal binnenlopende schepen een variabele is met een Poissonverdeling met $\lambda=2$ per dag.
...
\begin{enumerate}[label=(\alph*)]
    ...
    \answer{
        ...
        Dan geldt dat $X$ een Poissonverdeling volgt met parameter $\mu = \lambda \cdot t = 2 \cdot 1 = 2$.
        ...
        \[
            P(X > 3) = P(X \ge 4) = 1 - P(X \le 3) = 1 - \poissoncdf(\mu=2, k=3) \approx 0.1429.
        \]
    }
    ...
    \answer{
        Merk op dat het aantal schepen dat per dag kan worden afgehandeld begrensd is van boven door $3$, omdat in het geval van meer dan $3$ schepen de resterende schepen naar andere havens moeten uitwijken.
        ...
        \begin{center}
            \begin{tabular}{cc}
                ...
                \cmidrule{1-1} \cmidrule{2-2}
                    $0$ & $P(X=0) = \poissonpdf(\mu=2, k=0) \approx 0.1353$ \\
                    $1$ & $P(X=1) = \poissonpdf(\mu=2, k=1) \approx 0.2707$ \\
                    $2$ & $P(X=2) = \poissonpdf(\mu=2, k=2) \approx 0.2707$ \\
                    $3$ & $P(X \ge 3) = 1-\poissoncdf(\mu=2, k=2) \approx 0.3233$ \\
                \bottomrule
            \end{tabular}
        \end{center}
