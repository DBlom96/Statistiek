\question{7.3}{
    ...
    mag worden beschouwd als een kansvariabele $K$ met een Poissonverdeling met $\mu=4$ per dag.
...
\begin{enumerate}[label=(\alph*)]
    ...
    \answer{
        ...
        \[
            P(K > 3) = P(K \ge 4) = 1 - P(K \le 3) = 1 - \poissoncdf(\lambda=4, k=3) \approx 0.5665.
        \]
    }
