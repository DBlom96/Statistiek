...
\begin{enumerate}[label=(\alph*)]
    ...
    \answer{
        ...
        Het kritieke gebied is dus van de vorm $[g, \infty)$, waarbij $g$ de grenswaarde is waarvoor geldt $P(X \ge g) = \alpha=0.01$.
        Dit kunnen we met de grafische rekenmachine berekenen met behulp van de \enquote{solver}-functie, waarbij we het volgende systeem van vergelijkingen oplossen: 
        \begin{align*}
            E_1 &= \chi^2\text{cdf}(\lb=X, \ub=\GRinfinity, \df=2) \\
            E_2 &= 0.01.
        \end{align*}
        Dit geeft een kritieke grenswaarde van $x \approx 9.2103$.
    ...
    \answer{
        ...
        Om te bekijken hoe deze afhankelijkheid eruit ziet, is een analyse van de ruwe data (observed frequenties) nodig.
        Als we kijken naar de ruwe data, zien we dat het aandeel rokers in de leeftijdsgroep 30-<45 een stuk hoger ligt dan in de andere leeftijdsgroepen.
        Hierdoor kun je dus concluderen dat rookgewoontes niet vergelijkbaar zijn over alle leeftijdscategorie\"en.
        \begin{center}
