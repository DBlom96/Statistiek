...
\answer{
    Omdat we weer te maken hebben met twee \emph{nominale} variabelen, namelijk \enquote{rookgedrag} en \enquote{bloeddrukniveau}, kunnen we een chikwadraattoets uitvoeren om de onafhankelijkheid tussen beide variabelen te toetsen.
    We beginnen met het defini\"eren van de nulhypothese $H_0$ en de alternatieve hypothese $H_1$.
    \begin{itemize}
        \item[$H_0$:] de categorische variabelen \enquote{rookgedrag} en \enquote{bloeddrukniveau} zijn onafhankelijk van elkaar.
        \item[$H_1$:] de categorische variabelen \enquote{rookgedrag} en \enquote{bloeddrukniveau} zijn wel afhankelijk van elkaar.
    \end{itemize}
    ...
    Er is voldoende bewijs om aan te nemen dat de twee nominale variabelen \enquote{rookgedrag} en \enquote{bloeddrukniveau} afhankelijk zijn van elkaar.
    \vspace{1em}
    {
        \itshape Noot: de toetsuitslag van het verwerpen van $H_0$ laat niet zien hoe deze afhankelijkheid eruit ziet.
        Als je de ruwe data bekijkt, zie je echter dat onder de niet-rokers een groot deel gewoon een normale bloeddruk heeft, terwijl voor stevige rokers de meeste juist een ernstig verhoogde bloeddruk hebben.
