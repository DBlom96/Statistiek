...
\answer{
    ...
    De geobserveerde toetsingsgrootheid $\chi^2 \approx 10.1366$ ligt daarmee in het kritieke gebied en dus wordt $H_0$ verworpen.
    ...
    \begin{align*}
        p   &= P(X^2 \ge \chi^2) \\
            &= \chi^2\text{cdf}(\lb=\chi^2\approx 10.1366, \ub=\GRinfinity, \df=3) \\
            &\approx 0.0174
    \end{align*}
