...
\answer{
    ...
    \end{align*}
    Door dit stelsel vergelijkingen in te voeren in het \enquote{solver}-menu, krijgen we een waarde van $g \approx 7.8147$.
    ...
    \begin{align*}
        p   &= P(X^2 \ge \chi^2) \\
            &= \chi^2\text{cdf}(\lb=\chi^2\approx 10.1366; \ub=10^{10}; \df=3) \\
            &\approx 0.0174
    \end{align*}
