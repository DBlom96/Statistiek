...
\answer{
    ...
    \begin{itemize}
        ...
        \item[$H_1$:] de kansvariabele $X$ volgt een andere kansverdeling (merk op: dit kan nog steeds een binomiale verdeling zijn, maar met andere parameters!).
    \end{itemize}
    ...
    Omdat onder de nulhypothese $H_0$ geldt dat $X \sim \binomial{n=5}{p=0.20}$, kunnen we deze verwachte aantallen uitrekenen. 
