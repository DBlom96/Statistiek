...
\answer{
    ...
    Verder is gegeven dat er per dag $5$ orthopedische operaties zijn, die in \SI{20}{\percent} van de gevallen leidt tot complicaties.
    ...
    \end{align*}
    Deze grenswaarde berekenen we met de \enquote{solver}-optie door het volgende in te voeren:
    \begin{align*}
