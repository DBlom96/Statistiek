...
\begin{enumerate}[label=(\alph*)]
    ...
    \answer{
        ...
        \begin{center}
            \begin{tabular}{ccc|c}
                \toprule
                    \textbf{Scoreklasse} & \textbf{Man} & \textbf{Vrouw} & \textbf{Totaal} \\
                \midrule
                    $[30, 40)$ & $1$ & $0$ & $1$ \\
                    $[40, 50)$ & $1$ & $5$ & $6$ \\
                    $[50, 60)$ & $3$ & $0$ & $3$ \\
        ...
        \begin{center}
            \begin{tabular}{ccc|c}
                \toprule
                    \textbf{Scoreklasse} & \textbf{Man} & \textbf{Vrouw} & \textbf{Totaal} \\
                \midrule
                    $[30, 40)$ & \SI{5.6}{\percent} & \SI{0.0}{\percent} & \SI{5.6}{\percent} \\
                    $[40, 50)$ & \SI{5.6}{\percent} & \SI{41.7}{\percent} & \SI{47.3}{\percent} \\
                    $[50, 60)$ & \SI{16.7}{\percent} & \SI{0.0}{\percent} & \SI{16.7}{\percent} \\
                    $[60, 70)$ & \SI{22.2}{\percent} & \SI{16.7}{\percent} & \SI{38.9}{\percent} \\
                    $[70, 80)$ & \SI{11.1}{\percent} & \SI{33.3}{\percent} & \SI{44.4}{\percent} \\
                    $[80, 90)$ & \SI{22.2}{\percent} & \SI{8.3}{\percent} & \SI{30.5}{\percent} \\
                    $[90, 100)$ & \SI{16.7}{\percent} & \SI{0.0}{\percent} & \SI{16.7}{\percent} \\
                \midrule    
                    Totaal & \SI{60}{\percent} & \SI{40}{\percent} & \SI{100}{\percent} \\
                \bottomrule
            \end{tabular}
        \end{center}
    }
