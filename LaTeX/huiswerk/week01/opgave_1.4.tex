...
\answer{
    \begin{enumerate}[label=(\alph*)]
        ...
        \item Hoogte boven zeespiegel: intervalvariabele (merk op dat de zeespiegel een arbitrair gekozen nulpunt is, waardoor er eigenlijk geen absoluut nulpunt is.)
    \end{enumerate} 
}