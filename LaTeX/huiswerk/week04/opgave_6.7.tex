...
\begin{enumerate}[label=(\alph*)]
    ...
    \answer{
        Het aantal donoren met bloedgroep $A-$ binnen een groep van $8$ willekeurige donoren met bloedgroep $A$ is een binomiaal verdeelde kansvariabele $Y$ met parameters $n=8$ en $p = \frac{8}{36+8}=\frac{8}{44}$.
