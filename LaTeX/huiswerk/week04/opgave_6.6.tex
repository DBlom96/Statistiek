\question{6.6}{
    Bij een aangeboren afwijking blijkt bij \SI{25}{\percent} van de baby's een bepaalde complicatie op te treden.
...
\begin{enumerate}[label=(\alph*)]
    ...
    \answer{
        Het aantal baby's waarbij bij een aangeboren afwijking een bepaalde complicatie optreedt is een binomiaal verdeelde kansvariabele $X$ met parameters $n = 20$ (aantal baby's met een aangeboren afwijking) en $p = 0.25$ (kans op complicatie).
        Merk op dat het in deze context vreemd is om te spreken van een \enquote{succeskans} $p$.
        De kans dat twee of minder baby's de complicatie vertonen is gelijk aan
        \[
            P(X \le 2) = \binomcdf(n=20, p=0.25, k=2) \approx 0.0913.    
        \]
    }
    ...
    \answer{
        ...
        \[
            P(X = 2) = \binompdf(n=20, p=0.25, k=2) \approx 0.0670.    
        \]
    }
    ...
    \answer{
        ...
        \begin{align*}
            P(4 \le X \le 7)    &= P(X \le 7) - P(X \le 3) \\
                                &= \binomcdf(n=20, p=0.25, k=7) \\
                                &\qquad- \binomcdf(n=20, p=0.25, k=3) \\
