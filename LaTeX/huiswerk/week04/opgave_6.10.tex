...
\begin{enumerate}[label=(\alph*)]
    ...
    \answer{
        Het aantal motoren dat tijdens een vlucht uitvalt is een binomiaal verdeelde kansvariabele met parameters $n = 4$ (aantal motoren) en $p=0.005$ (in dit geval is het opnieuw vreemd om van een \enquote{succeskans} te spreken, kans op uitval van een motor).
