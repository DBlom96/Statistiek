\question{6.5}{
    Bekend is dat van de volwassen Nederlanders thans \SI{70}{\percent} over een of meer creditcards beschikt. 
...
\begin{enumerate}[label=(\alph*)]
    ...
    \answer{
        ...
        \[
            P(X=10) = \binompdf(n=15, p=0.7, k=10) \approx 0.2061.
        \]
    }
    ...
    \answer{
        ...
        \[
            P(X=15) = \binompdf(n=15, p=0.7, k=15) \approx 0.0047.
        \]
    }
    ...
    \answer{
        ...
        \[
            P(X < 12) = P(X \le 11) = \binomcdf(n=15, p=0.7, k=11) \approx 0.7031.
        \]
    }
\end{enumerate}