\question{6.4}{
    Een multiplechoice-examen bestaat uit tien vragen die elk drie antwoordmogelijkheden kennen, waarvan er precies \'e\'en correct is.
...
\begin{enumerate}[label=(\alph*)]
    ...
    \answer{
        De verwachtingswaarde van een binomiaal verdeelde kansvariabele $X \sim \binomial{n}{p}$ is gelijk aan $E[X]=n \cdot p$.
