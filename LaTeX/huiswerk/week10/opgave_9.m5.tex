...
\answer{
    ...
    We mochten immers veronderstellen dat $\sigma$ niet was veranderd.

    De theoretische toetsingsgrootheid is $Z = \frac{\overline{X} - \mu_0}{\sigma/\sqrt{n}}$ en volgt onder de nulhypothese $H_0: \mu=1510$ een standaardnormale verdeling.
    
    Onder de nulhypothese $H_0$ geldt op basis van de centrale limietstelling dat het steekproefgemiddelde $\samplemeanvarX \sim \normal{\mu=\ ?}{\frac{\sigma}{\sqrt{16}}}$.
    Omdat $\alpha = 0.05$, gebruiken we 
    \[
        z_{\alpha/2} = \invnorm(\opp=1-\alpha/2) = \invnorm(\opp=0.975) \approx 1.9600.
    \]
    Het acceptatiegebied is dan gegeven door
    \begin{align*}
        &\phantom{=}[\mu - z_{\alpha/2} \cdot \frac{\sigma}{\sqrt{16}}, \mu - z_{\alpha/2} \cdot \frac{\sigma}{\sqrt{16}}] \\
