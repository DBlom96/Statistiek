...
\answer{
    ...
    Er volgt dus dat $\samplemeanvarX \sim \normal{\mu=50}{\sigma=\frac{5}{\sqrt{50}}}$.
    Merk op dat hoe kleiner de toetsingsgrootheid is, hoe waarschijnlijker dat de alternatieve hypothese waar is.
    Het kritieke gebied is dus van de vorm $Z = (-\infty, g]$, waarbij $g$ kan worden berekend als volgt:
    \begin{align*}
    ...
    De geobserveerde toetsingsgrootheid $\samplemeanx=37.8$ ligt in het kritieke gebied, dus we verwerpen $H_0$.
