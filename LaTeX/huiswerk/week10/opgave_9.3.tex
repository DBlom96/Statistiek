...
\begin{enumerate}[label=(\alph*)]
    ...
    \answer{
        ...
        volgt dat $\frac{\sigma}{\sqrt{n}} = \frac{10}{\sqrt{1}}=10$, oftewel het theoretische steekproefgemiddelde $\samplemeanvar \sim \normal{\mu=50}{\sigma=10}$.
    ...
    \answer{
        \begin{itemize}
            ...
            volgt dat $\sigma(\samplemeanvar) = \frac{\sigma}{\sqrt{n}} = \frac{10}{\sqrt{100}}=1$, oftewel $\samplemeanvar \sim N(\mu=50; \sigma=1)$.
