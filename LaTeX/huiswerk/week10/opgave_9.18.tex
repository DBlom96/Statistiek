...
\answer{
    ...
    \begin{align*}
        \samplemean = \frac{x_1+x_2+\ldots+x_n}{n} = \frac{30+45+\ldots+28}{8} = 40.
    \end{align*}
    ...
    \begin{align*}
        \samplevar  &= \frac{(x_n-\samplemean)^2 + \ldots + (x_n-\samplemean)^2}{n-1} \\
                    &= \frac{(x_1-\samplemean)^2 + \ldots + (x_8-\samplemean)^2}{8-1} \\
    ...
    \]
    De toetsingsgrootheid is in dit geval het (theoretische) steekproefgemiddelde $\samplemeanvar$, die dus een $t$-verdeling volgt.
    ...
    De geobserveerde toetsingsgrootheid $\samplemean=40$ ligt in het kritieke gebied, dus verwerpen we de nulhypothese $H_0$.
