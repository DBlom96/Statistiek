...
\answer{
    ...
    \]
    De toetsingsgrootheid is in dit geval het (theoretische) steekproefgemiddelde $\samplemeanvarX$, die dus een $t$-verdeling volgt.
    Onder de aanname dat $H_0$ waar is, geldt dat het gemiddelde $\mu=51$.
    Merk op dat hoe verder het steekproefgemiddelde $\mu$ afligt van $51$ (zowel ver daaronder als ver daarboven), hoe waarschijnlijker dat de alternatieve hypothese waar is.
    Het kritieke gebied $Z$ is dus van de vorm $(-\infty, g_1]$ en $[g_2, \infty)$, waarbij $g_1$ en $g_2$ kunnen worden berekend als volgt:
        \begin{align*}
            g_1 &= \mu - t \cdot \frac{\samplestd}{\sqrt{n}} \\
                &= 51 - 2.3646 \cdot \frac{9.3350}{\sqrt{8}}\\
                &\approx 43.1957.\\
            g_2 &= \mu + t \cdot \frac{\samplestd}{\sqrt{n}} \\
                &= 51 + 2.3646 \cdot \frac{9.3350}{\sqrt{8}} \\
                &\approx 58.8043.    
        \end{align*}
    Het kritieke gebied $Z$ is dus gelijk aan $(-\infty, 43.1957]$ en $[58.8043, \infty)$.
    De geobserveerde toetsingsgrootheid $\samplemeanx=40$ ligt in het kritieke gebied, dus verwerpen we de nulhypothese $H_0$.
