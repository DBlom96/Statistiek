...
\answer{
    ...
    \begin{align*}
     s^2    &= \frac{(x_n-\overline{x})^2 + \ldots + (x_n-\overline{x})^2}{n-1} \\
            ...
            &\approx 87,1429
    \end{align*}
    Hierdoor volgt een schatting van de standaarddeviatie $s = \sqrt{s^2} = \sqrt{87,1429} \approx 9,3350$.
    ...
    Het kritieke gebied is dus gelijk aan $(-\infty; 43,1957]$ en $[58,8043, \infty)$.
