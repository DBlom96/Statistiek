...
\enanswer{
    $S = \{aaa, aab, aba, baa, abb, bab, bba, bbb\}$, where $a = \text{above}$ and $b = \text{below}$
}
...
\enanswer{
    $S = \{(1,1), (1,2), \dots, (1,5), (2,1), \dots, (5,5)\}$; $n_S = 25$
}
...
\enanswer{
    $S = \{c, bc, bbc, bbbc, \dots\}$, where $b = \text{busy}$ and $c = \text{connect}$
}
...
\enanswer{
    (a) The region outside circle $A$. \\
    (b) Simplifies to $A$; the entire circle $A$ is shaded. \\
    (c) The intersection region of $A$ and $B$, plus the entire circle $C$. \\
    (d) The portion of circle $A$ that does not overlap with either $B$ or $C$. \\
    (e) Everything outside the intersection of $A$ and $B$, plus the entire circle $C$.
}
...
\enanswer{
    \begin{tabular}{*{8}{l}}
        a. & $[65, \infty)$ & b. & $(0, 45.5]$ & c. & $(45.5, 65)$ & d. & $(,\infty)$
    \end{tabular}
}
...
\enanswer{
    \begin{tabular}{@{}l l}
        a. & $S = \{gg, gm, gb, mg, mm, mb, bg, bm, bb\}$, \\
           & where $g = \text{good}$, $m = \text{moderate}$ and $b = \text{bad}$ \\
        b. & $\{gg, gm, gb, mg, mm, mb, bg, bm\}$
    \end{tabular}
}
...
\enanswer{
    \begin{enumerate}[label=(\alph*)]
        \item $0.7$
        \item $0.95$
        \item No, because $P(A \cap B) = 0.70$. So $A \cap B \neq \varnothing$
    \end{enumerate}
}
