\usetikzlibrary{arrows.meta, backgrounds, bending, calc, decorations.markings, decorations.pathreplacing, intersections, patterns, positioning, shapes, trees}
...
% PMTPS
\tikzset{
  device/.style={rectangle, draw=blue, fill=blue!20, minimum size=0.6cm}
}